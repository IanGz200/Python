...
class Coloreable(ABC):
    """
    Superclase cuya funcion es modificar los colores
    """

    @abstractmethod
    def set_color(self, color:str)->None:
        """
        Metodo que aplica un color
    ...
    def get_color(self)->str:
        """
        :return: Metodo que devuelve el color
        """
        pass

class Shape(Coloreable):
    """
    ...
    def get_color(self) ->str:
        """
        :return Metodo que retorna el color
        """
        return self.color

    def set_color(self, color:str)->None:
        """
        Metodo que aplica el color
        :param color: color a aplicar
        """
        self.color = color
